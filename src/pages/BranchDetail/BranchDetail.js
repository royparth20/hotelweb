...
const BranchDetail = () => {
  ...
  const changeHandler = (event) => {
   ...
   async function CreateProfileAjax(image) {
    ...
    setLoader(true)
    var t = {"ownerName":pname,"mobile":bnumber,"email":bemail,"address":address,"hotelImages":[]};
    if(image)
    {
      t["hotelImages"] = [image];
    }
        ...
        <ContentWrapper className="p- m-0">
            <Row className="p-0 m-0">
              ...
              <Col lg={5} className="p-2 m-0">      
                <BDDetailForm  updatePNam={setPName} updateBMName={setBMName} updateAddress={setAddress} />
              </Col>
              <Col lg={4} className="p-2 m-0">      
                <BDContactForm   updateBEmail={setBEmail}  updateBNumber={setBNumber} />
              </Col>
            </Row>
            <Row className="">
